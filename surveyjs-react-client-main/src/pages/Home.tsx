            ...
            <nav>
                <ul className='sjs-sidebar-ul'>
                    <li className='sjs-sidebar-li'>
                        <a className='sjs-sidebar-a sjs-a-active' href='/home'>
                    ...
                    <li className='sjs-sidebar-li'>
                        <a className='sjs-sidebar-a' href='/analytics'>
                            <svg className='sjs-a-svg' width="16" height="16" viewBox="0 0 64 64" fill="" xmlns="http://www.w3.org/2000/svg">
                                <path className="svg-path" fill-rule="evenodd" clip-rule="evenodd" d="M40.17 1.34352C39.11 1.02352 38 1.62352 37.68 2.68352L37.66 2.75352C35.52 2.26352 33.29 1.99352 31 1.99352C14.46 2.00352 1 15.4635 1 32.0035C1 48.5435 14.46 62.0035 31 62.0035C43.85 62.0035 54.82 53.8735 59.09 42.4935L59.17 42.5135C60.23 42.8335 61.34 42.2335 61.66 41.1735C66.71 24.2735 57.07 6.40352 40.17 1.34352ZM55.36 37.2035L58.8 35.3535C58.69 36.2635 58.54 37.1835 58.33 38.0935L55.36 37.2035ZM58.97 30.7135L49.94 35.5835L45.78 34.3435L58.61 27.4235C58.79 28.5135 58.91 29.6135 58.97 30.7235V30.7135ZM57.63 23.4035L40.36 32.7235L36.2 31.4835L56.51 20.5235C56.93 21.4635 57.31 22.4235 57.63 23.4135V23.4035ZM54.61 16.9935L34.3 27.9535L35.54 23.7935L52.81 14.4735C53.46 15.2835 54.05 16.1235 54.61 16.9935ZM49.99 11.4535L37.16 18.3735L38.4 14.2135L47.43 9.34352C48.33 9.99352 49.18 10.7035 49.99 11.4535ZM43.46 6.94352L40.02 8.80352L40.91 5.83352C41.79 6.16352 42.64 6.54352 43.46 6.95352V6.94352ZM30.99 58.0135C16.65 58.0135 4.99 46.3535 4.99 32.0135C4.99 17.6735 16.66 6.00352 31 6.00352C32.89 6.00352 34.73 6.21352 36.51 6.60352L29.08 31.4335C28.76 32.4935 29.36 33.6035 30.42 33.9235L55.25 41.3535C51.49 51.0835 42.04 58.0135 30.99 58.0135Z"></path>
                            </svg>
                            <span>  Analytics</span>
                        </a>
                    </li>
